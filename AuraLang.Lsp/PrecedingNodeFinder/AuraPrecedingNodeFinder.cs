	...
	ITypedAuraExprVisitor<ITypedAuraAstNode?>
{
	...
	private ITypedAuraAstNode? Statement(ITypedAuraStatement stmt) { return stmt.Accept(this); }

	private ITypedAuraAstNode? Expression(ITypedAuraExpression expr) { return expr.Accept(this); }
	...
	public ITypedAuraAstNode? Visit(TypedAssignment assignment) { return Expression(assignment.Value); }
	...
	public ITypedAuraAstNode? Visit(TypedBinary binary) { return binary.Range.End == Position ? binary : null; }

	public ITypedAuraAstNode? Visit(TypedBlock block) { return block.Range.End == Position ? block : null; }

	public ITypedAuraAstNode? Visit(TypedCall call) { return call.Range.End == Position ? call : null; }

	public ITypedAuraAstNode? Visit(TypedGet get) { return get.Range.End == Position ? get : null; }

	public ITypedAuraAstNode? Visit(TypedGetIndex getIndex) { return getIndex.Range.End == Position ? getIndex : null; }
	...
	public ITypedAuraAstNode? Visit(TypedGrouping grouping) { return grouping.Range.End == Position ? grouping : null; }

	public ITypedAuraAstNode? Visit(TypedIf @if) { return @if.Range.End == Position ? @if : null; }

	public ITypedAuraAstNode? Visit(TypedNil nil) { return nil.Range.End == Position ? nil : null; }

	public ITypedAuraAstNode? Visit(TypedLogical logical) { return logical.Range.End == Position ? logical : null; }

	public ITypedAuraAstNode? Visit(TypedSet set) { return set.Range.End == Position ? set : null; }

	public ITypedAuraAstNode? Visit(TypedThis @this) { return @this.Range.End == Position ? @this : null; }

	public ITypedAuraAstNode? Visit(TypedUnary unary) { return unary.Range.End == Position ? unary : null; }

	public ITypedAuraAstNode? Visit(TypedVariable variable) { return variable.Range.End == Position ? variable : null; }

	public ITypedAuraAstNode? Visit(TypedIs @is) { return @is.Range.End == Position ? @is : null; }

	public ITypedAuraAstNode? Visit(TypedInterfacePlaceholder ip) { return ip.Range.End == Position ? ip : null; }
	...
	public ITypedAuraAstNode? Visit(TypedDefer defer) { return Expression(defer.Call); }
	...
	public ITypedAuraAstNode? Visit(TypedFor @for) { return @for.Range.End == Position ? @for : null; }

	public ITypedAuraAstNode? Visit(TypedForEach @foreach) { return @foreach.Range.End == Position ? @foreach : null; }
	...
	public ITypedAuraAstNode? Visit(TypedMod mod) { return mod.Range.End == Position ? mod : null; }
	...
	public ITypedAuraAstNode? Visit(TypedWhile @while) { return @while.Range.End == Position ? @while : null; }

	public ITypedAuraAstNode? Visit(TypedImport import) { return import.Range.End == Position ? import : null; }
	...
	public ITypedAuraAstNode? Visit(TypedComment comment) { return comment.Range.End == Position ? comment : null; }
	...
	public ITypedAuraAstNode? Visit(TypedBreak @break) { return @break.Range.End == Position ? @break : null; }

	public ITypedAuraAstNode? Visit(TypedYield yield) { return yield.Range.End == Position ? yield : null; }

	public ITypedAuraAstNode? Visit(PartiallyTypedClass partiallyTypedClass) { return null; }

	public ITypedAuraAstNode? Visit(TypedCheck check) { return check.Range.End == Position ? check : null; }

	public ITypedAuraAstNode? Visit(TypedStruct @struct) { return @struct.Range.End == Position ? @struct : null; }
}
